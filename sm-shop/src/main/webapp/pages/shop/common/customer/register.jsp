...
<c:set var="register_url" value="${pageContext.request.contextPath}/shop/customer/register.html"/>
	...
	<div id="main-content" class="container clearfix row-fluid">
			...
			<div class="span7 col-md-7 no-padding">
                <!-- 一个commandName 决定了form属性的前缀 即绑定的表单对象-->
				<form:form method="post" action="${register_url}" id="registrationForm" class="form-horizontal" commandName="customer">
					...
					<fieldset>
						<div class="control-group form-group">
							<label class="required control-label" for="firstName"><s:message code="label.generic.firstname" text="First Name"/></label>
							<div class="controls">
						...
						<div class="control-group form-group">
							<label class="required control-label" for="lastName"><s:message code="label.generic.lastname" text="Last Name"/></label>
							<div class="controls">
						...
						<div class="control-group form-group">
							...
							<div class="controls">
							 <form:select path="gender" id="sex">
						...
						<div class="control-group form-group">
							<label class="control-label required" for="registration_country"><s:message code="label.generic.country" text="Country"/></label>
							<div class="controls">
						...
						<div class="control-group form-group">
							<label class="control-label required" for="customer_zones"><s:message code="label.generic.stateprovince" text="State / Province"/></label>
							<div class="controls">
