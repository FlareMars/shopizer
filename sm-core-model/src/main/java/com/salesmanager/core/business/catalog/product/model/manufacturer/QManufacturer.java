...
public class QManufacturer extends EntityPathBase<Manufacturer> {
    ...
    public final SetPath<ManufacturerDescription, QManufacturerDescription> descriptions = this.<ManufacturerDescription, QManufacturerDescription>createSet("descriptions", ManufacturerDescription.class, QManufacturerDescription.class,INITS);
