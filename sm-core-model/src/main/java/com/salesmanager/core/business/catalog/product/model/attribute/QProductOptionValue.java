...
public class QProductOptionValue extends EntityPathBase<ProductOptionValue> {
    ...
    public final SetPath<ProductOptionValueDescription, QProductOptionValueDescription> descriptions = this.<ProductOptionValueDescription, QProductOptionValueDescription>createSet("descriptions", ProductOptionValueDescription.class, QProductOptionValueDescription.class,INITS);
