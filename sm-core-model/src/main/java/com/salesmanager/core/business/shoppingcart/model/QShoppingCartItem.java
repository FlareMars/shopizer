...
public class QShoppingCartItem extends EntityPathBase<ShoppingCartItem> {
    ...
    public final SetPath<ShoppingCartAttributeItem, QShoppingCartAttributeItem> attributes = this.<ShoppingCartAttributeItem, QShoppingCartAttributeItem>createSet("attributes", ShoppingCartAttributeItem.class, QShoppingCartAttributeItem.class,INITS);
