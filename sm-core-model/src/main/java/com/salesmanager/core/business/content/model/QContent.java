...
public class QContent extends EntityPathBase<Content> {
    ...
    public final ListPath<ContentDescription, QContentDescription> descriptions = this.<ContentDescription, QContentDescription>createList("descriptions", ContentDescription.class, QContentDescription.class,INITS);
