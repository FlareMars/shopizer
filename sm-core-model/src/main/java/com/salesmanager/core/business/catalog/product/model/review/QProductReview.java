...
public class QProductReview extends EntityPathBase<ProductReview> {
    ...
    public final SetPath<ProductReviewDescription, QProductReviewDescription> descriptions = this.<ProductReviewDescription, QProductReviewDescription>createSet("descriptions", ProductReviewDescription.class, QProductReviewDescription.class,INITS);
