...
public class QTaxRate extends EntityPathBase<TaxRate> {
    ...
    public final ListPath<TaxRateDescription, QTaxRateDescription> descriptions = this.<TaxRateDescription, QTaxRateDescription>createList("descriptions", TaxRateDescription.class, QTaxRateDescription.class,INITS);
    ...
    public final ListPath<TaxRate, QTaxRate> taxRates = this.<TaxRate, QTaxRate>createList("taxRates", TaxRate.class, QTaxRate.class,INITS);
