...
public class QOrderAccount extends EntityPathBase<OrderAccount> {
    ...
    public final SetPath<OrderAccountProduct, QOrderAccountProduct> orderAccountProducts = this.<OrderAccountProduct, QOrderAccountProduct>createSet("orderAccountProducts", OrderAccountProduct.class, QOrderAccountProduct.class,INITS);
