...
public class QCustomerOption extends EntityPathBase<CustomerOption> {
    ...
    public final SetPath<CustomerOptionDescription, QCustomerOptionDescription> descriptions = this.<CustomerOptionDescription, QCustomerOptionDescription>createSet("descriptions", CustomerOptionDescription.class, QCustomerOptionDescription.class,INITS);
