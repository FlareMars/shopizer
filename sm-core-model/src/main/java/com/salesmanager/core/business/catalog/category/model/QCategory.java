...
public class QCategory extends EntityPathBase<Category> {
    ...
    public final ListPath<Category, QCategory> categories = this.<Category, QCategory>createList("categories", Category.class, QCategory.class,INITS);
    ...
    public final ListPath<CategoryDescription, QCategoryDescription> descriptions = this.<CategoryDescription, QCategoryDescription>createList("descriptions", CategoryDescription.class, QCategoryDescription.class,INITS);
